...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/SmartBinConcept.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 210, 420, 250));

        jLabel4.setBackground(new java.awt.Color(0, 0, 0));
        jLabel4.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 51, 51));
        jLabel4.setText("SMART DUSTBIN MANAGEMENT");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 390, 30));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 0, 520, 590));
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jLabel7MouseClicked
        ...
        int flag = 0;
        for (int i = 0; i < dustbin_management.Dustbin_Management.authlist.size(); i++) {
            if (dustbin_management.Dustbin_Management.authlist.get(i).username.equals(USERNAME1)) {
                if (dustbin_management.Dustbin_Management.authlist.get(i).password.equals(PASSWORD1)) {
                    flag = 1;
                }
            }
        }
